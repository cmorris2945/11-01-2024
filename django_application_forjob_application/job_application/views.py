...
def index(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            email_message = EmailMessage("Forma submission confirmation", message_body, to=[email])
            email_message.send()

            messages.success(request, "Form submitted successfully! We'll be in touch 'Mac'....")
